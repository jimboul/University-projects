...
class Seller(Users.Users):
	...
	def change_program(self):
		...
		for row in cur:
			cli_id = row[0]
			client_found = True#tha ginei true mono ama mpoume sto loop (vrethike username!)
		...
		new_prog_update = ""
		for row2 in cur:
			new_prog_update = row2[0] #pairnoume to onoma tou programmatos
			program_found = True#tha ginei true mono ama mpoume sto loop (vrethike to program!)
